...
Stack: FastAPI 0.136+, Python 3.13, Pydantic ≥2.9.0 (camelCase schemas), Starlette ≥1.1.0, Uvicorn, Ruff, pytest, Docker. Logging: python-json-logger ≥4.0. MongoDB: pymongo ≥4.0.
