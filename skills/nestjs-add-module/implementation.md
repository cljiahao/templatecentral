<!-- ref: nestjs-add-module/implementation.md
     loaded-by: nestjs-add-module/SKILL.md
     prereq: Stack = NestJS. Do not invoke this file directly — it is loaded at runtime by the nestjs-add-module skill. -->
