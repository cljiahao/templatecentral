...
description: Use when adding AI/LLM features (OpenAI, Anthropic, Bedrock, etc.) to any templateCentral project — applies OWASP LLM Top 10 v2.0 mitigations, token budgets, and output validation patterns.
version: "1.0.0"
---
