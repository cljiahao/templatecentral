<!-- ref: shared-drift-check/implementation.md
     loaded-by: shared-drift-check/SKILL.md
     prereq: Drift check workflow. Do not invoke this file directly — it is loaded at runtime by the shared-drift-check skill. -->
