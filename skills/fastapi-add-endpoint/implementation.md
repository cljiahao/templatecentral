<!-- ref: fastapi-add-endpoint/implementation.md
     loaded-by: fastapi-add-endpoint/SKILL.md
     prereq: Stack = FastAPI. Do not invoke this file directly — it is loaded at runtime by the fastapi-add-endpoint skill. -->
