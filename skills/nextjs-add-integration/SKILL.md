...
description: Use when connecting to an external API (e.g., GitHub, Stripe, OpenAI) from a Next.js project and need a typed client, Zod response schemas, service layer, and factory pattern.
