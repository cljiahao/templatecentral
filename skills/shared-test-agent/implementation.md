<!-- ref: shared-test-agent/implementation.md
     loaded-by: shared-test-agent/SKILL.md
     prereq: Test agent workflow. Do not invoke this file directly — it is loaded at runtime by the shared-test-agent skill. -->
