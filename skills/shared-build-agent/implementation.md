<!-- ref: shared-build-agent/implementation.md
     loaded-by: shared-build-agent/SKILL.md
     prereq: Build agent workflow. Do not invoke this file directly — it is loaded at runtime by the shared-build-agent skill. -->
