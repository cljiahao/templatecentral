<!-- ref: nextjs-add-api-route/implementation.md
     loaded-by: nextjs-add-api-route/SKILL.md
     prereq: Stack = Next.js. Do not invoke this file directly — it is loaded at runtime by the nextjs-add-api-route skill. -->
