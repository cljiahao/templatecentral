<!-- ref: shared-update-agent/implementation.md
     loaded-by: shared-update-agent/SKILL.md
     prereq: Update agent workflow. Do not invoke this file directly — it is loaded at runtime by the shared-update-agent skill. -->
