<!-- ref: shared-task-management/implementation.md
     loaded-by: shared-task-management/SKILL.md
     prereq: Task management workflow. Do not invoke this file directly — it is loaded at runtime by the shared-task-management skill. -->
