<!-- ref: shared-migrate/implementation.md
     loaded-by: shared-migrate/SKILL.md
     prereq: Migration workflow. Do not invoke this file directly — it is loaded at runtime by the shared-migrate skill. -->
