<!-- ref: shared-add-component/vite-react.md
     loaded-by: shared-add-component/SKILL.md
     prereq: Stack = Vite + React. Do not invoke this file directly — it is loaded at runtime by the shared-add-component skill. -->
