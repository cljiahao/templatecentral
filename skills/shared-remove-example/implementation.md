<!-- ref: shared-remove-example/implementation.md
     loaded-by: shared-remove-example/SKILL.md
     prereq: Removing example code. Do not invoke this file directly — it is loaded at runtime by the shared-remove-example skill. -->
