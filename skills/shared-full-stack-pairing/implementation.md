<!-- ref: shared-full-stack-pairing/implementation.md
     loaded-by: shared-full-stack-pairing/SKILL.md
     prereq: Multi-stack pairing workflow. Do not invoke this file directly — it is loaded at runtime by the shared-full-stack-pairing skill. -->
