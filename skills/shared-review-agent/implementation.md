<!-- ref: shared-review-agent/implementation.md
     loaded-by: shared-review-agent/SKILL.md
     prereq: Review agent workflow. Do not invoke this file directly — it is loaded at runtime by the shared-review-agent skill. -->
